//* Importaciones
const { loginSecureService } = require('../services');
 ...
 * @returns {Funtion} loginSecureController
 */
module.exports = ( dependencies ) => {
    ...
    const services = {
        login: loginSecureService({ helpers, httpErrorHandler, models, useCases }),
    };
     ...
     */
    const loginSecureController = async ( req, res, next ) => {
        try {
            ...
            console.log('❌ LOGIN_SECURE_CONTROLLER_ERROR: ', errorController);
            next(errorController);
        }
    };

    return loginSecureController;
